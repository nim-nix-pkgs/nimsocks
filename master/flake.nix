{
  ...
  inputs."github-enthus1ast-nimisprivateip".owner = "nim-nix-pkgs";
  inputs."github-enthus1ast-nimisprivateip".ref   = "master";
  inputs."github-enthus1ast-nimisprivateip".repo  = "github-enthus1ast-nimisprivateip";
  inputs."github-enthus1ast-nimisprivateip".dir   = "master";
  inputs."github-enthus1ast-nimisprivateip".type  = "github";
  inputs."github-enthus1ast-nimisprivateip".inputs.nixpkgs.follows = "nixpkgs";
  inputs."github-enthus1ast-nimisprivateip".inputs.flakeNimbleLib.follows = "flakeNimbleLib";
